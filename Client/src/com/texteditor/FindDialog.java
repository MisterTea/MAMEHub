...
/**
 * 
 * class for the creation and visualization of the dialog
 * with find and replace features
 * 
...
public class FindDialog extends JDialog implements ActionListener {
	...
	private void createComponent()
	{
		...
		labelFind = new JLabel("Find", JLabel.CENTER);
		this.getContentPane().add(labelFind);
		textFind = new JTextField("");
		this.getContentPane().add(textFind);
		labelReplace = new JLabel("Replace With", JLabel.CENTER);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(source.equals(buttonFind))
		{
			if (!textFind.getText().equalsIgnoreCase(""))
			{
				...
				JOptionPane.showMessageDialog(this, "You must insert some word/s in the TextField Find", "Error", JOptionPane.ERROR_MESSAGE);
		}
		else if (source.equals(buttonReplace))
		{
			if(textReplace.getText().equalsIgnoreCase(""))
				JOptionPane.showMessageDialog(this, "You must insert some word/s in the TextField Replace", "Error", JOptionPane.ERROR_MESSAGE);
			else if (textPane.getSelectedText() == null)
			{
				JOptionPane.showMessageDialog(this, "You must select some text", "Error", JOptionPane.ERROR_MESSAGE);
			}
			else
			{
