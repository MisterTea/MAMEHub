		...
		printButton.addActionListener(new ActionListener() 
	  	{
	  		public void actionPerformed (ActionEvent e) 
	  		{	
	  			int risp = JOptionPane.showOptionDialog(null, "Are you sure to print the license?", "Print", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
	  			...
	  			if (risp == 0)
	  			{
		  			...
		  			int n = (int) (pj.defaultPage().getImageableHeight() - pj.defaultPage().getImageableY())/license.getFont().getSize();
		  			Vector v = new Vector();
		  			...
		  			try {
						if (pj.printDialog())
						{
							...
							try
							{
								...
								JOptionPane.showMessageDialog(null, "Error in the printing of the license", "Print Error", JOptionPane.ERROR_MESSAGE);
							}
						}
					} catch (Exception e1)
					{
