...
public class MessageQueue implements org.apache.thrift.TBase<MessageQueue, MessageQueue._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(MessageQueue other) {
    ...
    MessageQueue typedOther = (MessageQueue)other;
