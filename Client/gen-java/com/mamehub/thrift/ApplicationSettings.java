...
public class ApplicationSettings implements org.apache.thrift.TBase<ApplicationSettings, ApplicationSettings._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(ApplicationSettings other) {
    ...
    ApplicationSettings typedOther = (ApplicationSettings)other;
    ...
    lastComparison = Boolean.valueOf(isSetChatAudio()).compareTo(typedOther.isSetChatAudio());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChatAudio()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.chatAudio, typedOther.chatAudio);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetChatStatus()).compareTo(typedOther.isSetChatStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChatStatus()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.chatStatus, typedOther.chatStatus);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLastInternalLoginId()).compareTo(typedOther.isSetLastInternalLoginId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLastInternalLoginId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.lastInternalLoginId, typedOther.lastInternalLoginId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetAllowUploading()).compareTo(typedOther.isSetAllowUploading());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAllowUploading()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.allowUploading, typedOther.allowUploading);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
