...
public class UserSession implements org.apache.thrift.TBase<UserSession, UserSession._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(UserSession other) {
    ...
    UserSession typedOther = (UserSession)other;
    ...
    lastComparison = Boolean.valueOf(isSetExpirationTime()).compareTo(typedOther.isSetExpirationTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExpirationTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.expirationTime, typedOther.expirationTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
