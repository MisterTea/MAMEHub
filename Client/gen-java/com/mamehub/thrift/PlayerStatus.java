...
public class PlayerStatus implements org.apache.thrift.TBase<PlayerStatus, PlayerStatus._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(PlayerStatus other) {
    ...
    PlayerStatus typedOther = (PlayerStatus)other;
