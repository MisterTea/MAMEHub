...
public class MediaType implements org.apache.thrift.TBase<MediaType, MediaType._Fields>, java.io.Serializable, Cloneable {
  ...
  public MediaType(MediaType other) {
    ...
    if (other.isSetExtensions()) {
      List<String> __this__extensions = new ArrayList<String>();
      for (String other_element : other.extensions) {
        __this__extensions.add(other_element);
      }
  ...
  public int compareTo(MediaType other) {
    ...
    MediaType typedOther = (MediaType)other;

    lastComparison = Boolean.valueOf(isSetMediaName()).compareTo(typedOther.isSetMediaName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMediaName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.mediaName, typedOther.mediaName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
