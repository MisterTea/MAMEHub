...
public class FileResponse implements org.apache.thrift.TBase<FileResponse, FileResponse._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(FileResponse other) {
    ...
    FileResponse typedOther = (FileResponse)other;

    lastComparison = Boolean.valueOf(isSetDataHex()).compareTo(typedOther.isSetDataHex());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDataHex()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataHex, typedOther.dataHex);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
