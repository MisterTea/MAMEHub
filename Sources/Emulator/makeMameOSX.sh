...
#nice nice make -j1 MACOSX_USE_LIBSDL=1 PTR64=1 NOWERROR=1 TARGET=ume DEBUG=1 SYMBOLS=1 PROFILER=1 SYMBOLS=1 CC=/usr/bin/clang LD=/usr/bin/clang++ AR=/usr/bin/ar
