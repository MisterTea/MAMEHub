...
public class DownloadableRomState implements org.apache.thrift.TBase<DownloadableRomState, DownloadableRomState._Fields>, java.io.Serializable, Cloneable, Comparable<DownloadableRomState> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.roms = new HashMap<String,Set<String>>(2*_map110.size);
                for (int _i111 = 0; _i111 < _map110.size; ++_i111)
                {
                  ...
                  struct.roms.put(_key112, _val113);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DownloadableRomState struct) throws org.apache.thrift.TException {
      ...
      if (struct.roms != null) {
        oprot.writeFieldBegin(ROMS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Set<String>> _iter117 : struct.roms.entrySet())
          {
            oprot.writeString(_iter117.getKey());
            {
              oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, _iter117.getValue().size()));
  ...
  private static class DownloadableRomStateTupleScheme extends TupleScheme<DownloadableRomState> {
      ...
      if (struct.isSetRoms()) {
        {
          ...
          for (Map.Entry<String, Set<String>> _iter119 : struct.roms.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, DownloadableRomState struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map121 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.SET, iprot.readI32());
          struct.roms = new HashMap<String,Set<String>>(2*_map121.size);
          for (int _i122 = 0; _i122 < _map121.size; ++_i122)
          {
            ...
            struct.roms.put(_key123, _val124);
          }
        }
        struct.setRomsIsSet(true);
      }
