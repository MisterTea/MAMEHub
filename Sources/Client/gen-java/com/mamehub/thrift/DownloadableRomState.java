            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.roms = new HashMap<String,Set<String>>(2*_map102.size);
                for (int _i103 = 0; _i103 < _map102.size; ++_i103)
                {
                  ...
                  struct.roms.put(_key104, _val105);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DownloadableRomState struct) throws org.apache.thrift.TException {
      ...
      if (struct.roms != null) {
        oprot.writeFieldBegin(ROMS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Set<String>> _iter109 : struct.roms.entrySet())
          {
      ...
      if (struct.isSetRoms()) {
        {
          ...
          for (Map.Entry<String, Set<String>> _iter111 : struct.roms.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.roms = new HashMap<String,Set<String>>(2*_map113.size);
          for (int _i114 = 0; _i114 < _map113.size; ++_i114)
          {
            ...
            struct.roms.put(_key115, _val116);
          }
        }
        struct.setRomsIsSet(true);
      }
