            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.extensions = new ArrayList<String>(_list28.size);
                for (int _i29 = 0; _i29 < _list28.size; ++_i29)
                {
                  String _elem30;
                  _elem30 = iprot.readString();
                  struct.extensions.add(_elem30);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MediaType struct) throws org.apache.thrift.TException {
      ...
      if (struct.extensions != null) {
        oprot.writeFieldBegin(EXTENSIONS_FIELD_DESC);
        {
          ...
          for (String _iter31 : struct.extensions)
          {
      ...
      if (struct.isSetExtensions()) {
        {
          ...
          for (String _iter32 : struct.extensions)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.extensions = new ArrayList<String>(_list33.size);
          for (int _i34 = 0; _i34 < _list33.size; ++_i34)
          {
            String _elem35;
            _elem35 = iprot.readString();
            struct.extensions.add(_elem35);
          }
        }
        struct.setExtensionsIsSet(true);
      }
