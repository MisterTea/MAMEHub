...
public class Message implements org.apache.thrift.TBase<Message, Message._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Message other) {
    ...
    if (isSetChat()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.chat, typedOther.chat);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetPlayerChanged()).compareTo(typedOther.isSetPlayerChanged());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPlayerChanged()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.playerChanged, typedOther.playerChanged);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetGameChanged()).compareTo(typedOther.isSetGameChanged());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGameChanged()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.gameChanged, typedOther.gameChanged);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
