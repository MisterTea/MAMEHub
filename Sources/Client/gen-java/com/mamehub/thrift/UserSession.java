            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.data = new HashMap<String,String>(2*_map46.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserSession struct) throws org.apache.thrift.TException {
      ...
      if (struct.data != null) {
        oprot.writeFieldBegin(DATA_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter50 : struct.data.entrySet())
          {
      ...
      if (struct.isSetData()) {
        {
          ...
          for (Map.Entry<String, String> _iter51 : struct.data.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.data = new HashMap<String,String>(2*_map52.size);
