            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.loggedInPlayers = new HashMap<String,Player>(2*_map80.size);
                for (int _i81 = 0; _i81 < _map80.size; ++_i81)
                {
                  ...
                  _val83 = new Player();
                  _val83.read(iprot);
                  struct.loggedInPlayers.put(_key82, _val83);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.games = new HashMap<String,Game>(2*_map84.size);
                for (int _i85 = 0; _i85 < _map84.size; ++_i85)
                {
                  ...
                  _val87 = new Game();
                  _val87.read(iprot);
                  struct.games.put(_key86, _val87);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ServerState struct) throws org.apache.thrift.TException {
      ...
      if (struct.loggedInPlayers != null) {
        oprot.writeFieldBegin(LOGGED_IN_PLAYERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Player> _iter88 : struct.loggedInPlayers.entrySet())
          {
      ...
      if (struct.games != null) {
        oprot.writeFieldBegin(GAMES_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Game> _iter89 : struct.games.entrySet())
          {
      ...
      if (struct.isSetLoggedInPlayers()) {
        {
          ...
          for (Map.Entry<String, Player> _iter90 : struct.loggedInPlayers.entrySet())
          {
      ...
      if (struct.isSetGames()) {
        {
          ...
          for (Map.Entry<String, Game> _iter91 : struct.games.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.loggedInPlayers = new HashMap<String,Player>(2*_map92.size);
          for (int _i93 = 0; _i93 < _map92.size; ++_i93)
          {
            ...
            _val95 = new Player();
            _val95.read(iprot);
            struct.loggedInPlayers.put(_key94, _val95);
          }
        }
        struct.setLoggedInPlayersIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.games = new HashMap<String,Game>(2*_map96.size);
          for (int _i97 = 0; _i97 < _map96.size; ++_i97)
          {
            ...
            _val99 = new Game();
            _val99.read(iprot);
            struct.games.put(_key98, _val99);
          }
        }
        struct.setGamesIsSet(true);
      }
