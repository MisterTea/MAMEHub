            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.loggedInPlayers = new HashMap<String,Player>(2*_map72.size);
                for (int _i73 = 0; _i73 < _map72.size; ++_i73)
                {
                  ...
                  _val75 = new Player();
                  _val75.read(iprot);
                  struct.loggedInPlayers.put(_key74, _val75);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.games = new HashMap<String,Game>(2*_map76.size);
                for (int _i77 = 0; _i77 < _map76.size; ++_i77)
                {
                  ...
                  _val79 = new Game();
                  _val79.read(iprot);
                  struct.games.put(_key78, _val79);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ServerState struct) throws org.apache.thrift.TException {
      ...
      if (struct.loggedInPlayers != null) {
        oprot.writeFieldBegin(LOGGED_IN_PLAYERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Player> _iter80 : struct.loggedInPlayers.entrySet())
          {
      ...
      if (struct.games != null) {
        oprot.writeFieldBegin(GAMES_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Game> _iter81 : struct.games.entrySet())
          {
      ...
      if (struct.isSetLoggedInPlayers()) {
        {
          ...
          for (Map.Entry<String, Player> _iter82 : struct.loggedInPlayers.entrySet())
          {
      ...
      if (struct.isSetGames()) {
        {
          ...
          for (Map.Entry<String, Game> _iter83 : struct.games.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.loggedInPlayers = new HashMap<String,Player>(2*_map84.size);
          for (int _i85 = 0; _i85 < _map84.size; ++_i85)
          {
            ...
            _val87 = new Player();
            _val87.read(iprot);
            struct.loggedInPlayers.put(_key86, _val87);
          }
        }
        struct.setLoggedInPlayersIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.games = new HashMap<String,Game>(2*_map88.size);
          for (int _i89 = 0; _i89 < _map88.size; ++_i89)
          {
            ...
            _val91 = new Game();
            _val91.read(iprot);
            struct.games.put(_key90, _val91);
          }
        }
        struct.setGamesIsSet(true);
      }
