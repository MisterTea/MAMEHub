            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.romProfiles = new HashMap<String,PlayerRomProfile>(2*_map36.size);
                for (int _i37 = 0; _i37 < _map36.size; ++_i37)
                {
                  String _key38;
                  PlayerRomProfile _val39;
                  _key38 = iprot.readString();
                  _val39 = new PlayerRomProfile();
                  _val39.read(iprot);
                  struct.romProfiles.put(_key38, _val39);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PlayerProfile struct) throws org.apache.thrift.TException {
      ...
      if (struct.romProfiles != null) {
        oprot.writeFieldBegin(ROM_PROFILES_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, PlayerRomProfile> _iter40 : struct.romProfiles.entrySet())
          {
      ...
      if (struct.isSetRomProfiles()) {
        {
          ...
          for (Map.Entry<String, PlayerRomProfile> _iter41 : struct.romProfiles.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.romProfiles = new HashMap<String,PlayerRomProfile>(2*_map42.size);
          for (int _i43 = 0; _i43 < _map42.size; ++_i43)
          {
            String _key44;
            PlayerRomProfile _val45;
            _key44 = iprot.readString();
            _val45 = new PlayerRomProfile();
            _val45.read(iprot);
            struct.romProfiles.put(_key44, _val45);
          }
        }
        struct.setRomProfilesIsSet(true);
      }
