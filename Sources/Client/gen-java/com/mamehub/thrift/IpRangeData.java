...
public class IpRangeData implements org.apache.thrift.TBase<IpRangeData, IpRangeData._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(IpRangeData other) {
    ...
    IpRangeData typedOther = (IpRangeData)other;

    lastComparison = Boolean.valueOf(isSetIpStart()).compareTo(typedOther.isSetIpStart());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIpStart()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ipStart, typedOther.ipStart);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetIpEnd()).compareTo(typedOther.isSetIpEnd());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIpEnd()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ipEnd, typedOther.ipEnd);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCountryCode2()).compareTo(typedOther.isSetCountryCode2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCountryCode2()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.countryCode2, typedOther.countryCode2);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCountryCode3()).compareTo(typedOther.isSetCountryCode3());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCountryCode3()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.countryCode3, typedOther.countryCode3);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCountryName()).compareTo(typedOther.isSetCountryName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCountryName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.countryName, typedOther.countryName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
