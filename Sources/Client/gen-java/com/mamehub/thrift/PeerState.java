            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.downloadableRoms = new HashMap<String,Set<String>>(2*_map84.size);
                for (int _i85 = 0; _i85 < _map84.size; ++_i85)
                {
                  ...
                  struct.downloadableRoms.put(_key86, _val87);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PeerState struct) throws org.apache.thrift.TException {
      ...
      if (struct.downloadableRoms != null) {
        oprot.writeFieldBegin(DOWNLOADABLE_ROMS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Set<String>> _iter91 : struct.downloadableRoms.entrySet())
          {
      ...
      if (struct.isSetDownloadableRoms()) {
        {
          ...
          for (Map.Entry<String, Set<String>> _iter93 : struct.downloadableRoms.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.downloadableRoms = new HashMap<String,Set<String>>(2*_map95.size);
          for (int _i96 = 0; _i96 < _map95.size; ++_i96)
          {
            ...
            struct.downloadableRoms.put(_key97, _val98);
          }
        }
        struct.setDownloadableRomsIsSet(true);
      }
