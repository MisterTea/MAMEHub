...
public class PeerState implements org.apache.thrift.TBase<PeerState, PeerState._Fields>, java.io.Serializable, Cloneable, Comparable<PeerState> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.downloadableRoms = new HashMap<String,Set<String>>(2*_map92.size);
                for (int _i93 = 0; _i93 < _map92.size; ++_i93)
                {
                  ...
                  _key94 = iprot.readString();
                  {
                    ...
                    _val95 = new HashSet<String>(2*_set96.size);
                  ...
                  struct.downloadableRoms.put(_key94, _val95);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PeerState struct) throws org.apache.thrift.TException {
      ...
      if (struct.downloadableRoms != null) {
        oprot.writeFieldBegin(DOWNLOADABLE_ROMS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Set<String>> _iter99 : struct.downloadableRoms.entrySet())
          {
            oprot.writeString(_iter99.getKey());
            {
              oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, _iter99.getValue().size()));
  ...
  private static class PeerStateTupleScheme extends TupleScheme<PeerState> {
      ...
      if (struct.isSetDownloadableRoms()) {
        {
          ...
          for (Map.Entry<String, Set<String>> _iter101 : struct.downloadableRoms.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PeerState struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map103 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.SET, iprot.readI32());
          struct.downloadableRoms = new HashMap<String,Set<String>>(2*_map103.size);
          for (int _i104 = 0; _i104 < _map103.size; ++_i104)
          {
            ...
            _key105 = iprot.readString();
            {
              ...
              _val106 = new HashSet<String>(2*_set107.size);
            ...
            struct.downloadableRoms.put(_key105, _val106);
          }
        }
        struct.setDownloadableRomsIsSet(true);
      }
