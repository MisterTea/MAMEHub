            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.messages = new ArrayList<Message>(_list64.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MessageQueue struct) throws org.apache.thrift.TException {
      ...
      if (struct.messages != null) {
        oprot.writeFieldBegin(MESSAGES_FIELD_DESC);
        {
          ...
          for (Message _iter67 : struct.messages)
          {
            _iter67.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetMessages()) {
        {
          ...
          for (Message _iter68 : struct.messages)
          {
            _iter68.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.messages = new ArrayList<Message>(_list69.size);
