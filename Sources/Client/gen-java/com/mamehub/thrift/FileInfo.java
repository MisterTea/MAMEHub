            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.contentsCrc32 = new HashMap<String,String>(2*_map26.size);
                for (int _i27 = 0; _i27 < _map26.size; ++_i27)
                {
                  ...
                  struct.contentsCrc32.put(_key28, _val29);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.contentsCrc32 != null) {
        oprot.writeFieldBegin(CONTENTS_CRC32_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter30 : struct.contentsCrc32.entrySet())
          {
      ...
      if (struct.isSetContentsCrc32()) {
        {
          ...
          for (Map.Entry<String, String> _iter31 : struct.contentsCrc32.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.contentsCrc32 = new HashMap<String,String>(2*_map32.size);
          for (int _i33 = 0; _i33 < _map32.size; ++_i33)
          {
            ...
            struct.contentsCrc32.put(_key34, _val35);
          }
        }
        struct.setContentsCrc32IsSet(true);
      }
