            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.contentsCrc32 = new HashMap<String,String>(2*_map18.size);
                for (int _i19 = 0; _i19 < _map18.size; ++_i19)
                {
                  ...
                  struct.contentsCrc32.put(_key20, _val21);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.contentsCrc32 != null) {
        oprot.writeFieldBegin(CONTENTS_CRC32_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter22 : struct.contentsCrc32.entrySet())
          {
      ...
      if (struct.isSetContentsCrc32()) {
        {
          ...
          for (Map.Entry<String, String> _iter23 : struct.contentsCrc32.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.contentsCrc32 = new HashMap<String,String>(2*_map24.size);
          for (int _i25 = 0; _i25 < _map24.size; ++_i25)
          {
            ...
            struct.contentsCrc32.put(_key26, _val27);
          }
        }
        struct.setContentsCrc32IsSet(true);
      }
