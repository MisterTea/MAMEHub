...
/**
 * Simple PageTemplate that lists the WizardPage description at the top of each
 * page in the wizard.
 * 
 * @author rogue
 */
public class TitledPageTemplate extends PageTemplate {
   ...
   * logic, since it doesn't include any additional decorations it is ideal for
   * nesting.
   */
  ...
  public TitledPageTemplate() {
    ...
    Border innerBorder = BorderFactory.createMatteBorder(0, 0, 1, 0,
        Color.black);

    // combine the two borders to get the desired look:
    _title.setBorder(BorderFactory.createCompoundBorder(outerBorder,
        innerBorder));
   ...
   * 
   * @see
   * org.ciscavate.cjwizard.pagetemplates.PageTemplate#setPage(org.ciscavate
   * .cjwizard.WizardPage)
   */
  @Override
