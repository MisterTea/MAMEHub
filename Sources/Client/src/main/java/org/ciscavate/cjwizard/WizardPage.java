...
public abstract class WizardPage extends JPanel {
  ...
  /**
   * The collection of components that have been added to this wizard page with
   * set names.
   */
  ...
  /**
   * Listener to keep track of the components as they are added and removed from
   * this wizard page.
   * 
   * @author rogue
   */
  private class WPContainerListener implements ContainerListener {
    ...
    private void storeIfNamed(Component newComp) {
      if (newComp instanceof CustomWizardComponent && null != newComp.getName()) {
