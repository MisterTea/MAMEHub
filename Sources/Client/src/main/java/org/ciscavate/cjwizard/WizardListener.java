...
/**
 * A simple interface to enable arbitrary code to act in response to wizard
 * actions.
 * 
 * @author rcreswick
 *
...
public interface WizardListener {
   ...
   * 
   * @param newPage
   *          The new page displayed.
   * @param path
   *          The list of WizardPages shown so far.
   */
   ...
   *          The list of WizardPages shown so far.
   * @param settings
   *          The collection of settings gleaned during the wizard.
   */
