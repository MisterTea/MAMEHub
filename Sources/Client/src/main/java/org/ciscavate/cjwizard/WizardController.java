...
public interface WizardController {
  ...
  /**
   * Transfer the state of the dialog to the specified page. If this page has
   * been seen before, move back to that state. Otherwise, add the page to the
   * path and continue from there.
   * 
   * @param page
   *          The page to visit.
   */
  ...
  /**
   * Forcibly visit the previous page. This is equivalent to the user clicking
   * on "< Prev", but this <b>can</b> be done when the button is disabled.
   */
  public void prev();
