...
/**
 * This class provides a point at which third-party code can introduce custom
 * wrappers around the WizardPages that are displayed. To do so, implement the
 * IPageTemplate interface and wrap this PageTemplate class with your own custom
 * components, delegating the setPage invocation to the wrapped instance of
 * PageTemplate.
 * 
 * @author rcreswick
 *
...
public class DefaultPageTemplate extends PageTemplate {
   ...
   * 
   * @see
   * org.ciscavate.cjwizard.PageTemplate#setPage(org.ciscavate.cjwizard.WizardPage
   * )
   */
  @Override
