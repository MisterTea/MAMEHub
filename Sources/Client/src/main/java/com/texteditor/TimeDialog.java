...
/**
 * 
 * class for the creation and visualization of a dialog with
 * "insert date and time" feature
 * 
...
public class TimeDialog extends JDialog implements ActionListener {
  ...
  private void createComponent() {
    timeLabel = new JLabel("Select a format", SwingConstants.CENTER);
    comboTime = new JComboBox(new String[] { "dd/MM/yy HH:mm:ss",
        "dd/MM/yy HH:mm", "dd/MM HH:mm:ss", "dd/MM HH:mm", "dd/MM/yy",
        "HH:mm:ss", "HH:mm" });
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (source.equals(okButton)) {
      ...
      SimpleDateFormat sdf = new SimpleDateFormat(comboTime.getSelectedItem()
          .toString());
      String formatted = sdf.format(time);
      String text = textPane.getText();
      int position = textPane.getCaretPosition();
      textPane.setText(text.substring(0, position) + formatted
