      ...
      getContentPane().add(buttonPane, BorderLayout.SOUTH);
      {
        ...
        okButton.addActionListener(new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            if (newPasswordOnce.getText().length() > 0) {
              if (!rpcEngine.changePassword(oldPassword.getText(),
                  newPasswordOnce.getText())) {
                JOptionPane
                    .showMessageDialog(UpdateProfileDialog.this,
                        "You must enter a correct old password to change your password.");
                return;
              }
            }
