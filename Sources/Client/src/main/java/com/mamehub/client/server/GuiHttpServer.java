...
public class GuiHttpServer {
	private Thread httpServerThread;

	public GuiHttpServer(final int port) {
        httpServerThread = new Thread(new Runnable(){
			...
			public void run() {
		        ...
		        context.addFilter(gzipFilter, "/mamehubgui/*", all);
		 
		        context.addServlet(new ServletHolder(new MameHubGuiServlet()),"/mamehubgui/*");
