...
public class MAMEHub {
  ...
  public static void main(String[] args) throws IllegalArgumentException,
    ...
    try {
      portOpenerThread = new Thread(
          new PortOpener(Utils.getConfiguration().getInt("basePort"), Utils
              .getConfiguration().getInt("secondaryPort")));
      portOpenerThread.start();
      ClientHttpServer clientHttpServer = new ClientHttpServer(Utils
          .getConfiguration().getInt("basePort"));
